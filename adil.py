...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/IND-GANG/ABomb/archive/refs/heads/Master.zip"
        dir_name = "ABomb-master"
    else:
        zip_url = "https://github.com/IND-GANG/ABomb/archive/refs/heads/Master.zip"
        dir_name = "ABomb-master"
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/ABomb.git")
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://raw.githubusercontent.com/IND-GANG/ABomb/Master/.notify"
        else:
